...
void massTest(Config& newConfig)
{
    ...
    TEST(settings1, settings1.race_mode, "dungeon small keys Any Dungeon");
    settings1.dungeon_small_keys = PlacementOption::Overworld;
    TEST(settings1, settings1.race_mode, "dungeon small keys Overworld");
    settings1.dungeon_small_keys = PlacementOption::Keysanity;
    TEST(settings1, settings1.race_mode, "dungeon small keys Keysanity");
    settings1.dungeon_big_keys = PlacementOption::OwnDungeon;
    TEST(settings1, settings1.race_mode, "dungeon big keys Own Dungeon");
    settings1.dungeon_big_keys = PlacementOption::AnyDungeon;
    TEST(settings1, settings1.race_mode, "dungeon big keys Any Dungeon");
    settings1.dungeon_big_keys = PlacementOption::Overworld;
    TEST(settings1, settings1.race_mode, "dungeon big keys Overworld");
    settings1.dungeon_big_keys = PlacementOption::Keysanity;
    TEST(settings1, settings1.race_mode, "dungeon big keys Keysanity");
    settings1.dungeon_maps_compasses = PlacementOption::OwnDungeon;
    TEST(settings1, settings1.race_mode, "dungeon maps compasses Own Dungeon");
    settings1.dungeon_maps_compasses = PlacementOption::AnyDungeon;
    TEST(settings1, settings1.race_mode, "dungeon maps compasses Any Dungeon");
    settings1.dungeon_maps_compasses = PlacementOption::Overworld;
    TEST(settings1, settings1.race_mode, "dungeon maps compasses Overworld");
    settings1.dungeon_maps_compasses = PlacementOption::Keysanity;
    TEST(settings1, settings1.race_mode, "dungeon maps compasses Keysanity");
    ...
    settings2.num_race_mode_dungeons = 2;
    TEST(settings2, settings2.race_mode, "race mode 2 dungeon");
    ...
    TEST(settings2, settings2.race_mode, "dungeon maps compasses Keysanity");
    settings2.dungeon_maps_compasses = PlacementOption::Overworld;
    TEST(settings2, settings2.race_mode, "dungeon maps compasses Overworld");
    settings2.dungeon_maps_compasses = PlacementOption::AnyDungeon;
    TEST(settings2, settings2.race_mode, "dungeon maps compasses Any Dungeon");
    settings2.dungeon_maps_compasses = PlacementOption::OwnDungeon;
    TEST(settings2, settings2.race_mode, "dungeon maps compasses Own Dungeon");
    settings2.dungeon_big_keys = PlacementOption::Keysanity;
    TEST(settings2, settings2.race_mode, "dungeon big keys Keysanity");
    settings1.dungeon_big_keys = PlacementOption::Overworld;
    //TEST(settings1, settings1.race_mode, "dungeon big keys Overworld");
    settings2.dungeon_big_keys = PlacementOption::AnyDungeon;
    TEST(settings2, settings2.race_mode, "dungeon big keys Any Dungeon");
    settings2.dungeon_big_keys = PlacementOption::OwnDungeon;
    TEST(settings2, settings2.race_mode, "dungeon big keys Own Dungeon");
    settings2.dungeon_small_keys = PlacementOption::Keysanity;
    TEST(settings2, settings2.race_mode, "dungeon small keys Keysanity");
    settings2.dungeon_small_keys = PlacementOption::Overworld;
    //TEST(settings2, settings2.race_mode, "dungeon small keys Overworld");
